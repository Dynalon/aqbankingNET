...
%define gitdir	aqbankingNET-git
...
# extract and move the git sources to the builddir
cd $RPM_SOURCE_DIR
# find the .tar file generated by osc service or copied from a stable release
export SOURCE_TAR=`ls $RPM_SOURCE_DIR/*aqbankingNET*.tar*`
export SOURCE_FOLDER=`echo -n $SOURCE_TAR | cut -f 1 -d.`
/bin/tar xfv "$SOURCE_TAR"
mv $SOURCE_FOLDER/* $RPM_BUILD_DIR/%{gitdir}

%build
cd $RPM_BUILD_DIR/%{gitdir}
make
